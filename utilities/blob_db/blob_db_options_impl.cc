...
BlobDBOptionsImpl::BlobDBOptionsImpl(const BlobDBOptions& in)
    : BlobDBOptions(in),
      ...
      gc_file_pct(100),
      gc_check_period_millisecs(5 * 1000),
      sanity_check_period_millisecs(5 * 1000),
      open_files_trigger(100),
      wa_num_stats_periods(24),
      wa_stats_period_millisecs(5 * 1000),
      partial_expiration_gc_range_secs(4 * 3600),
      partial_expiration_pct(50),
      fsync_files_period_millisecs(5 * 1000),
      reclaim_of_period_millisecs(1 * 1000),
      delete_obsf_period_millisecs(5 * 1000),
      check_seqf_period_millisecs(5 * 1000),
